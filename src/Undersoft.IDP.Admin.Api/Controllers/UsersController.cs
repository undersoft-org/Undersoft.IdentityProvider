...
namespace Undersoft.IDP.Admin.Api.Controllers
{
        ...
        where TRoleClaimDto : RoleClaimDto<TKey>
    {
        ...
        {
            var user = await _identityService.GetUserAsync(Int64.Parse(id.ToString()));
        ...
        public async Task<ActionResult<TUserDto>> Post([FromBody]TUserDto user)
        {
            ...
            var createdUser = await _identityService.GetUserAsync(Int64.Parse(userId.ToString()));
        ...
        {
            await _identityService.GetUserAsync(Int64.Parse(user.Id.ToString()));
        ...
        public async Task<IActionResult> PostUserRoles([FromBody]UserRoleApiDto<TKey> role)
        {
            ...
            await _identityService.GetUserAsync(Int64.Parse(userRolesDto.UserId.ToString()));
