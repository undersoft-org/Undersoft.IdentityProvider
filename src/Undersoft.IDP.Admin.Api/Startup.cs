...
using Undersoft.IDP.Admin.Api.Configuration.Authorization;
using Undersoft.IDP.Admin.Api.ExceptionHandling;
using Undersoft.IDP.Admin.Api.Helpers;
using Undersoft.IDP.Admin.Api.Mappers;
...
namespace Undersoft.IDP.Admin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                typeof(IdentityMapperProfile<IdentityRoleDto, IdentityUserRolesDto, long, IdentityUserClaimsDto, IdentityUserClaimDto, IdentityUserProviderDto, IdentityUserProvidersDto, IdentityUserChangePasswordDto, IdentityRoleClaimDto, IdentityRoleClaimsDto>)
            };

            services.AddAdminAspNetIdentityServices<AdminIdentityDbContext, IdentityServerPersistedGrantDbContext,
                IdentityUserDto, IdentityRoleDto, UserIdentity, UserIdentityRole, long, UserIdentityUserClaim, UserIdentityUserRole,
                ...
                options.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        Password = new OpenApiOAuthFlow
                        {
                            ...
                            Scopes = adminApiConfiguration.Scopes.ToDictionary(s => s)                        
                        }
                    }
                });
