...
using Undersoft.IDP.STS.Identity.Configuration;
using Undersoft.IDP.STS.Identity.Configuration.ApplicationParts;
using Undersoft.IDP.STS.Identity.Configuration.Constants;
using Undersoft.IDP.STS.Identity.Configuration.Interfaces;
using Undersoft.IDP.STS.Identity.Helpers.Localization;
using System.Linq;
...
using Undersoft.IDP.Admin.EntityFramework.Configuration.MySql;
using Undersoft.IDP.Admin.EntityFramework.Configuration.PostgreSQL;
using Undersoft.IDP.Admin.EntityFramework.Configuration.SqlServer;
using Undersoft.IDP.Shared.Configuration.Authentication;
using Undersoft.IDP.Shared.Configuration.Configuration.Identity;

namespace Undersoft.IDP.STS.Identity.Helpers
{
