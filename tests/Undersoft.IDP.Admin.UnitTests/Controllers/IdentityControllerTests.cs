...
using Undersoft.IDP.Admin.UI.Areas.AdminUI.Controllers;
...
namespace Undersoft.IDP.Admin.UnitTests.Controllers
{
    public class IdentityControllerTests
    {
        private IIdentityService<UserDto<long>, RoleDto<long>,
            ...
            RoleClaimsDto<RoleClaimDto<long>, long>, UserClaimDto<long>, RoleClaimDto<long>> GetIdentityService(IServiceProvider services)
        {
        ...
        public async Task DeleteUser()
        {
            ...
            var subjectClaim = new Claim(IdentityModel.JwtClaimTypes.Subject, userDto.Id.ToString());
        ...
        private IdentityController<UserDto<long>, RoleDto<long>,
            ...
            UsersDto<UserDto<long>, long>, RolesDto<RoleDto<long>, long>, UserRolesDto<RoleDto<long>, long>,
            UserClaimsDto<UserClaimDto<long>, long>, UserProviderDto<long>, UserProvidersDto<UserProviderDto<long>, long>, UserChangePasswordDto<long>,
            RoleClaimsDto<RoleClaimDto<long>, long>, UserClaimDto<long>, RoleClaimDto<long>> PrepareIdentityController(IServiceProvider serviceProvider)
        {
            // Arrange
            ...
            var controller = new IdentityController<UserDto<long>, RoleDto<long>,
                ...
                UsersDto<UserDto<long>, long>, RolesDto<RoleDto<long>, long>, UserRolesDto<RoleDto<long>, long>,
                UserClaimsDto<UserClaimDto<long>, long>, UserProviderDto<long>, UserProvidersDto<UserProviderDto<long>, long>, UserChangePasswordDto<long>,
                RoleClaimsDto<RoleClaimDto<long>, long>, UserClaimDto<long>, RoleClaimDto<long>>(identityService, logger, localizer);
